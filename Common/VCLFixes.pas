...
function GetMethodAddress(AMessageID: Word;
                          AClass: TClass;
...
function PatchInstructionByte(MethodAddress: Pointer;
                              ExpectedOffset: Cardinal;
                              ExpectedValue: Byte;
                              NewValue: Byte): Boolean;
var
  BytePtr: PByte;
  OldProtect: Cardinal;
begin
...
function PatchInstructionBytes(MethodAddress: Pointer;
                               ExpectedOffset: Cardinal;
                               const ExpectedValues: array of Byte;
...
begin
  ...
  else if (not PatchInstructionBytes(MethodAddress, 10, [$08, $8B], [$04, $90, $90, $90], [$04, $E8])) // release and package
