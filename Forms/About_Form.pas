...
begin
   ...
   lblInfo2.Caption := Format(' This program is freeware and released under the%s                GNU General Public License.%s%s       The %s project (2006-2020)', [lb, lb, lb, PROGRAM_NAME]);
end;
