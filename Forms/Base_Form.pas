...
uses
   Vcl.Forms, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.ComCtrls, OmniXML,
   BaseEnumerator, CommonTypes, CommonInterfaces;
...
function TBaseForm.Remove(ANode: TTreeNode = nil): boolean;
begin
   result := CanRemove;
end;
